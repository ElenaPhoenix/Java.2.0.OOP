...
public class Main { static ArrayList<BaseHero> holyTeam = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        //holyTeam.forEach(n -> System.out.println(n.getInfo() + " " + n.getName() + " (здоровье " + n.getHp() + ")"));
        Additionally.getList(darkTeam, 10);
        //darkTeam.forEach(n -> System.out.println(n.getInfo() + " " + n.getName() + " (здоровье " + n.getHp() + ")"));
